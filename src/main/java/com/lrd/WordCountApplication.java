...
public class WordCountApplication {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        KTable<Windowed<String>, Long> counts = source
                ...
                .count(TimeWindows.of(  10 * 1000L).advanceBy(10 * 1000L),"Counts");

        KStream<String, Long> stringcounts = counts
        ...
        stringcounts.to(Serdes.String(), Serdes.Long(), "streams-wordcount-output");
